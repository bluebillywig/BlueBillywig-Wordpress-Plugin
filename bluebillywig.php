...
define('BB_PLUGIN_VERSION', '0.3.2.1');
...
define('BB_API_SETTINGS_DEFAULT', array(
	BB_API_SETTINGS_PUBLICATION => "",
...
class BlueBillywig
{
	...
	public function get_rpc()
	{
		if ($this->rpc == null) {
			$this->create_rpc(
				$this->apiOptions[BB_API_SETTINGS_PUBLICATION],
...
?>
	...
	<style>
		.mce-bb-widget-no-video-selected {
			color: red !important
		}
	</style>
<?php
